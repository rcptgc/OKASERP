...
#include "ui_PrePaintProcessViewCls.h"
#include "Utility/UtilsCls.h"

PrePaintProcessViewCls::PrePaintProcessViewCls(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::PrePaintProcessViewCls)
{
    ui->setupUi(this);
...
PrePaintProcessViewCls::~PrePaintProcessViewCls()
{
    delete ui;
}

void PrePaintProcessViewCls::SaveTankLog(void)
{
...
void PrePaintProcessViewCls::ShowFinish(void)
{


}

void PrePaintProcessViewCls::ShowLoad(void)
{
...
void PrePaintProcessViewCls::LoadProductionEntryPage()
{
...
void PrePaintProcessViewCls::LoadEditLoadPage()
{
    m_LoggerPtr->CreateTraceLog(Q_FUNC_INFO, " ");
    m_LoggerPtr->CreateUserLog(m_UserPtr, Q_FUNC_INFO, " ");
...
void PrePaintProcessViewCls::LoadCreateLoadPage()
{
    m_LoggerPtr->CreateTraceLog(Q_FUNC_INFO, " ");
    m_LoggerPtr->CreateUserLog(m_UserPtr, Q_FUNC_INFO, " ");
