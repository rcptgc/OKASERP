...
#include "ui_QualityProcessViewPageCls.h"
#include "Utility/UtilsCls.h"

QualityProcessViewPageCls::QualityProcessViewPageCls(QWidget *parent) : QMainWindow(parent), ui(new Ui::QualityProcessViewPageCls)
{
    ...
    connect(ui->pushButtonSaveFinish,   SIGNAL(clicked()),          this,   SLOT(SaveQualityLog()));
...
QualityProcessViewPageCls::~QualityProcessViewPageCls()
{
    delete ui;
}

void QualityProcessViewPageCls::SaveQualityLog(void)
{
...
void QualityProcessViewPageCls::ShowFinish(void)
{


}

void QualityProcessViewPageCls::ShowLoad(void)
{
...
void QualityProcessViewPageCls::LoadProductionEntryPage()
{
...
void QualityProcessViewPageCls::LoadEditLoadPage()
{
    m_LoggerPtr->CreateTraceLog(Q_FUNC_INFO, " ");
    m_LoggerPtr->CreateUserLog(m_UserPtr, Q_FUNC_INFO, " ");
...
void QualityProcessViewPageCls::LoadCreateLoadPage()
{
    m_LoggerPtr->CreateTraceLog(Q_FUNC_INFO, " ");
    m_LoggerPtr->CreateUserLog(m_UserPtr, Q_FUNC_INFO, " ");
