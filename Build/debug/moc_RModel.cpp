...
QT_MOC_LITERAL(1, 7, 10), // "RowChecked"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 3), // "Row"
QT_MOC_LITERAL(4, 23, 5) // "state"

    },
    "RModel\0RowChecked\0\0Row\0state"
};
...
void RModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RModel *_t = static_cast<RModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RModel::*)(int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RModel::RowChecked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RModel::staticMetaObject = {
    { &QSqlQueryModel::staticMetaObject, qt_meta_stringdata_RModel.data,
      qt_meta_data_RModel,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void RModel::RowChecked(int _t1, bool _t2)
{
